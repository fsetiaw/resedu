...
public class SearchQueryAkunTable_v1 extends OtakuSQL {
	PreparedStatement stmt = null;
	Connection conn = null;
	ResultSet rs = null;
	

	public Response returnListNamaAkun() throws Exception {
		Response res = null;
		try {
			
			conn = OtakuSQL.connectToUsg();
			stmt = conn.prepareStatement("select NAMA_AKUN,OLD_NICKNAME from AKUN order by NAMA_AKUN");
