...
public class SearchQueryClassPoolRulesTable_v1 extends OtakuSQL {
	PreparedStatement stmt = null;
	Connection conn = null;
	ResultSet rs = null;
	

	public Response returnListClassPoolRules(String thsms) throws Exception {
		Response res = null;
		try {
			
			conn = OtakuSQL.connectToUsg();
			stmt = conn.prepareStatement("select * from CLASS_POOL_RULES where THSMS=?");
