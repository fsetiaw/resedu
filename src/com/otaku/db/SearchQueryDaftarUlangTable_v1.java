...
public class SearchQueryDaftarUlangTable_v1 extends OtakuSQL {
	...
	public Response returnListRules(String thsms_target) throws Exception {
		Response res = null;
		try {
			
			conn = OtakuSQL.connectToUsg();
			stmt = conn.prepareStatement("select * from DAFTAR_ULANG_RULES where THSMS=? order by KDPST");
			stmt.setString(1,thsms_target);
