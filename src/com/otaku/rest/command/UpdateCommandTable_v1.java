package com.otaku.rest.command;
	...
	*/
	...
	public Response updateCommandTable(@PathParam("token_trans") String token_trans, @PathParam("token_input_value") String token_input_value) throws Exception {
		...
		try {
			...
			res = uob.updateDataFromFormUpdate(token_trans,token_input_value);
			//res = sob.returnInfo();
		}
		catch (Exception e) {
			e.printStackTrace();
