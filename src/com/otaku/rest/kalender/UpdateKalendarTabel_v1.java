...
@Path("/v1/kalender/update")
public class UpdateKalendarTabel_v1 {
private static final String version = "ver.1";
	...
	*/
	...
	public Response updateKalenderParam(@PathParam("token_trans") String token_trans, @PathParam("token_input_value") String token_input_value) throws Exception {
		...
		try {
			UpdateQueryKalenderTable_v1 uob = new UpdateQueryKalenderTable_v1();
			if(token_trans!=null) {
			...
			res = uob.updateDataFromFormSettingParam(token_trans,token_input_value);
			//res = sob.returnInfo();
		}
		catch (Exception e) {
			e.printStackTrace();
